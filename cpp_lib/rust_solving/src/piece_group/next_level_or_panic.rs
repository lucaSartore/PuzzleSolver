use crate::piece_group::{AddShoreOfSubComponents, HasBasicComponents, Comparable, HasKnownLevel, HasOrientation, IsSubComponent, PieceArrayFiller, PieceGroup};
...
use crate::piece_group::intersection_comparable::IntersectionComparable;
...
pub trait NextLevelOrPanic:
    Clone + HasOrientation + Send +
    Comparable + IsSubComponent +
    HasKnownLevel + PieceArrayFiller +
    Sync + HasBasicComponents<Self> +
    AddShoreOfSubComponents +
    IntersectionComparable
{
