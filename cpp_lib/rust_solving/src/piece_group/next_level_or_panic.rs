...
pub trait NextLevelOrPanic: Clone + HasOrientation + Send + Comparable + IsSubComponent + HasKnownLevel + PieceArrayFiller + Sync + HasBasicComponents<Self> + AddShoreOfSubComponents{
