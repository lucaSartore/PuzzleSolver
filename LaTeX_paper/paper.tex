...
\begin{itemize}
  ...
  \item P\texttt{ieceGroup\(<\)T\(>\)} where \texttt{T} can be either a \texttt{PieceGroup} or a \texttt{SinglePiece}\newline
...
\end{itemize}
Both \texttt{SinglePiece} and \texttt{PieceGroup} have an ``orientation'' attribute that goes from 0 to 3~\cref{fig:orientation}.
\begin{figure}[H]
...
>{\columncolor[HTML]{FFF2CC}}c 
>{\columncolor[HTML]{EAD1DC}}c }
\multicolumn{3}{c}{\cellcolor[HTML]{EA9999}Manualy evaluated accuracy of the solution}                       \\
