...
\begin{itemize}
  ...
  Finally the filler areas are added back to the only if
  ...
  image all pixels that are in close proximity to a blob generated by a knob.
  ...
  An example of a single side can be seen in image F4l.~\ref{fig:s_s_a_piece_side}.
\end{itemize}
...
This implies a imit match\% of 0.04 and a corruption rate of 0.057.
