...
reliable comparator~\cref{document:comparator}, that could provide accurate information even with noisy 
...
as well as the Splitter~\cref{document:splitter}
and Comparator~\cref{document:comparator} algorithms.
