...
\subsection{Difference In Execution Time}

This section measures the execution time of many puzzles,
and plots the results. The puzzles that has been used for
...
In particular we selected the ``Graph Connection Laplacian'' solution, due to the
...
pieces fit together, followed by scanning them and labeling,
is a time-intensive process that could require hundreds,
if not thousands, of hours.

However we just created a puzzle solver, even with a suboptimal
